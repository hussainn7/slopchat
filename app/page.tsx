...
const GITHUB_URL = "https://github.com/hussainn7/slopchat";
...
async function getGitHubStars(): Promise<number | null> {
  try {
    const res = await fetch("https://api.github.com/repos/hussainn7/slopchat", {
    ...
    <main className="min-h-screen bg-white text-zinc-900">
        ...
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-5 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="View SlopChat on GitHub"
            >
      ...
      <footer className="border-t border-zinc-200 py-8">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 text-sm text-zinc-500 sm:px-6 lg:px-8">
          <span className="font-semibold text-zinc-600">SlopChat</span>
          <a
            href={GITHUB_URL}
            target="_blank"
            rel="noreferrer"
